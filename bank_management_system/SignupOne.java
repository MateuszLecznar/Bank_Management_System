...
public class SignupOne extends JFrame implements ActionListener {
    ...
    JRadioButton male,female,gender_other,married, unmarried;
    JButton next;
    ...
    SignupOne() {
        ...
        //Title
        JLabel formno = new JLabel("Application Formo No."+random);
        ...
        personalDetail.setFont(new Font("Raleway",Font.ITALIC,22));
        personalDetail.setBounds(290,80,400,30);
        add(personalDetail);


        //Name and others persolnal specyfication
        ...
        fname.setFont(new Font("Raleway",Font.ITALIC,20));
        ...
        gender_other.setBounds(600,290,100,30);
        gender_other.setBackground(Color.LIGHT_GRAY);
        add(gender_other);

        ButtonGroup gender_group = new ButtonGroup();
        gender_group.add(male);
        gender_group.add(female);
        gender_group.add(gender_other);
        ...
        marital.setFont(new Font("Raleway",Font.ITALIC,20));
        ...
        address.setFont(new Font("Raleway",Font.ITALIC,20));
        ...
        state.setFont(new Font("Raleway",Font.ITALIC,20));
        ...
        pincode.setFont(new Font("Raleway",Font.ITALIC,20));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if(name.equals("")){
                ...
                Conn c = new Conn();
                String Java00 = "insert into signup values('"+formno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+pin+"', '"+state+"')";
                c.s.executeUpdate(Java00);
                }
